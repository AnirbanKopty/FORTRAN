program mol_dist
    ...
    OPEN(UNIT=14, FILE='nuc_plot.dat', STATUS='replace')
    ...
    OPEN(UNIT=15, FILE='param.dat', STATUS='replace')
    WRITE (15,"(A, f0.4, A, f0.4, A)") "The Inter-nuclear distance, given B = ", B, " per m is, R = ", R, " pm"
    CLOSE(15)
